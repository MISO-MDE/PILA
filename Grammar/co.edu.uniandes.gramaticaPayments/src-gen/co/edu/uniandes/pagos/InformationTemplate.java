 ...
 *   <li>{@link co.edu.uniandes.pagos.InformationTemplate#getFormLists <em>Form Lists</em>}</li>
...
public interface InformationTemplate extends EObject
{
   ...
   * </p>
   * <!-- end-user-doc -->
   * @return the value of the '<em>Form Lists</em>' containment reference list.
   * @see co.edu.uniandes.pagos.PagosPackage#getInformationTemplate_FormLists()
