 ...
 *   <li>{@link co.edu.uniandes.pagos.impl.CalculationTemplateImpl#getFormula <em>Formula</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CalculationTemplateImpl extends MinimalEObjectImpl.Container implements CalculationTemplate
{
  ...
  public EList<Formula> getFormula()
  {
    if (formula == null)
    {
      formula = new EObjectContainmentEList<Formula>(Formula.class, this, PagosPackage.CALCULATION_TEMPLATE__FORMULA);
    }
    return formula;
  }
