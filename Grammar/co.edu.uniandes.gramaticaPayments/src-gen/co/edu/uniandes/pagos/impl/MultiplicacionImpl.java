 ...
 * </p>
 * <ul>
 *   <li>{@link co.edu.uniandes.pagos.impl.MultiplicacionImpl#getLeft <em>Left</em>}</li>
 *   <li>{@link co.edu.uniandes.pagos.impl.MultiplicacionImpl#getOperator <em>Operator</em>}</li>
 *   <li>{@link co.edu.uniandes.pagos.impl.MultiplicacionImpl#getRexp <em>Rexp</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MultiplicacionImpl extends ExpressionImpl implements Multiplicacion
{
   ...
   * @generated
   */
  public NotificationChain basicSetOperator(mathMULT newOperator, NotificationChain msgs)
  {
    mathMULT oldOperator = operator;
    operator = newOperator;
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PagosPackage.MULTIPLICACION__OPERATOR, oldOperator, newOperator);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
   ...
   * @generated
   */
  public void setOperator(mathMULT newOperator)
  {
    if (newOperator != operator)
    {
      NotificationChain msgs = null;
      if (operator != null)
        msgs = ((InternalEObject)operator).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PagosPackage.MULTIPLICACION__OPERATOR, null, msgs);
      if (newOperator != null)
        msgs = ((InternalEObject)newOperator).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PagosPackage.MULTIPLICACION__OPERATOR, null, msgs);
      msgs = basicSetOperator(newOperator, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PagosPackage.MULTIPLICACION__OPERATOR, newOperator, newOperator));
  }
