 ...
 *   <li>{@link co.edu.uniandes.pagos.SuperEntity#getParticipante <em>Participante</em>}</li>
 * </ul>
 *
...
public interface SuperEntity extends EObject
{
  ...
  /**
   * Returns the value of the '<em><b>Participante</b></em>' containment reference list.
   * The list contents are of type {@link co.edu.uniandes.pagos.Participant}.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Participante</em>' containment reference list isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @return the value of the '<em>Participante</em>' containment reference list.
   * @see co.edu.uniandes.pagos.PagosPackage#getSuperEntity_Participante()
   * @model containment="true"
   * @generated
   */
  EList<Participant> getParticipante();
