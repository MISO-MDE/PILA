...
@after {
	...
	(
		...
		(
			...
			this_LBRACKET_29=RULE_LBRACKET
			{
			...
			this_RBRACKET_33=RULE_RBRACKET
			{
...
// Entry rule entryRulemathADD
entryRulemathADD returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getMathADDRule()); }
	iv_rulemathADD=rulemathADD
	{ $current=$iv_rulemathADD.current; }
	EOF;

// Rule mathADD
rulemathADD returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
// Entry rule entryRulemathMULT
entryRulemathMULT returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getMathMULTRule()); }
	iv_rulemathMULT=rulemathMULT
	{ $current=$iv_rulemathMULT.current; }
	EOF;

// Rule mathMULT
rulemathMULT returns [EObject current=null]
@init {
	enterRule();
}
@after {
