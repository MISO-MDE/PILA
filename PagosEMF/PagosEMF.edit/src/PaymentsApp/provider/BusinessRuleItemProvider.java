...
/**
 * This is the item provider adapter for a {@link PaymentsApp.BusinessRule} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BusinessRuleItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BusinessRule_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BusinessRule_name_feature", "_UI_BusinessRule_type"),
				 PaymentsAppPackage.Literals.BUSINESS_RULE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BusinessRule_description_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BusinessRule_description_feature", "_UI_BusinessRule_type"),
				 PaymentsAppPackage.Literals.BUSINESS_RULE__DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PaymentsAppPackage.Literals.BUSINESS_RULE__BUSINESS_CONDITIONS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PaymentsAppPackage.Literals.BUSINESS_RULE__BUSINESS_CONDITIONS,
				 PaymentsAppFactory.eINSTANCE.createBusinessCondition()));
	}
