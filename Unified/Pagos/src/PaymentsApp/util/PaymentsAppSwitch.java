...
public class PaymentsAppSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case PaymentsAppPackage.CALCULATION_TEMPLATE: {
			...
			case PaymentsAppPackage.TERMINAL_VALUE: {
			...
			case PaymentsAppPackage.ADICION: {
			...
			case PaymentsAppPackage.MULTIPLICACION: {
