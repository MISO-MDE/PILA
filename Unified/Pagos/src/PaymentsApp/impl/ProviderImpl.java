 ...
 *   <li>{@link PaymentsApp.impl.ProviderImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link PaymentsApp.impl.ProviderImpl#getAttLists <em>Att Lists</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProviderImpl extends EObjectImpl implements Provider {
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PaymentsAppPackage.PROVIDER__DESCRIPTION, oldDescription, description));
	}
	...
	public EList<BusinessAttribute> getAttLists() {
		if (attLists == null) {
			attLists = new EObjectContainmentEList<BusinessAttribute>(BusinessAttribute.class, this, PaymentsAppPackage.PROVIDER__ATT_LISTS);
		}
		return attLists;
	}
