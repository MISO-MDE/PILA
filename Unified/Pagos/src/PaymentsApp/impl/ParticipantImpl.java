 ...
 *   <li>{@link PaymentsApp.impl.ParticipantImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link PaymentsApp.impl.ParticipantImpl#getAttLists <em>Att Lists</em>}</li>
 *   <li>{@link PaymentsApp.impl.ParticipantImpl#getTemplatesForms <em>Templates Forms</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParticipantImpl extends EObjectImpl implements Participant {
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PaymentsAppPackage.PARTICIPANT__DESCRIPTION, oldDescription, description));
	}
	...
	public EList<BusinessAttribute> getAttLists() {
		if (attLists == null) {
			attLists = new EObjectContainmentEList<BusinessAttribute>(BusinessAttribute.class, this, PaymentsAppPackage.PARTICIPANT__ATT_LISTS);
		}
		return attLists;
	}
	...
	public EList<InformationTemplate> getTemplatesForms() {
		if (templatesForms == null) {
			templatesForms = new EObjectContainmentEList<InformationTemplate>(InformationTemplate.class, this, PaymentsAppPackage.PARTICIPANT__TEMPLATES_FORMS);
		}
