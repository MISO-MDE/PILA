 ...
 *   <li>{@link PaymentsApp.impl.InformationTemplateImpl#getAttLists <em>Att Lists</em>}</li>
 *   <li>{@link PaymentsApp.impl.InformationTemplateImpl#getTemplates <em>Templates</em>}</li>
 *   <li>{@link PaymentsApp.impl.InformationTemplateImpl#getProviders <em>Providers</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InformationTemplateImpl extends EObjectImpl implements InformationTemplate {
	...
	public EList<BusinessAttribute> getAttLists() {
		if (attLists == null) {
			attLists = new EObjectContainmentEList<BusinessAttribute>(BusinessAttribute.class, this, PaymentsAppPackage.INFORMATION_TEMPLATE__ATT_LISTS);
		}
		return attLists;
	}
	...
	public EList<CalculationTemplate> getTemplates() {
		if (templates == null) {
			templates = new EObjectContainmentEList<CalculationTemplate>(CalculationTemplate.class, this, PaymentsAppPackage.INFORMATION_TEMPLATE__TEMPLATES);
		}
		return templates;
	}
	...
	public EList<Provider> getProviders() {
		if (providers == null) {
			providers = new EObjectContainmentEList<Provider>(Provider.class, this, PaymentsAppPackage.INFORMATION_TEMPLATE__PROVIDERS);
		}
		return providers;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PaymentsAppPackage.INFORMATION_TEMPLATE__ATT_LISTS:
				return ((InternalEList<?>)getAttLists()).basicRemove(otherEnd, msgs);
			case PaymentsAppPackage.INFORMATION_TEMPLATE__TEMPLATES:
				return ((InternalEList<?>)getTemplates()).basicRemove(otherEnd, msgs);
			case PaymentsAppPackage.INFORMATION_TEMPLATE__PROVIDERS:
