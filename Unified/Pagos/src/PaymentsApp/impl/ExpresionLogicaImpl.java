 ...
 * </p>
 * <ul>
 *   <li>{@link PaymentsApp.impl.ExpresionLogicaImpl#getVariable <em>Variable</em>}</li>
 *   <li>{@link PaymentsApp.impl.ExpresionLogicaImpl#getLogOper <em>Log Oper</em>}</li>
 *   <li>{@link PaymentsApp.impl.ExpresionLogicaImpl#getVariable2 <em>Variable2</em>}</li>
 *   <li>{@link PaymentsApp.impl.ExpresionLogicaImpl#getLiteral <em>Literal</em>}</li>
 *   <li>{@link PaymentsApp.impl.ExpresionLogicaImpl#getExp <em>Exp</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExpresionLogicaImpl extends EObjectImpl implements ExpresionLogica {
	...
	protected EClass eStaticClass() {
		return PaymentsAppPackage.Literals.EXPRESION_LOGICA;
	}
	...
	public EList<TerminalValue> getVariable() {
		if (variable == null) {
			variable = new EObjectContainmentEList<TerminalValue>(TerminalValue.class, this, PaymentsAppPackage.EXPRESION_LOGICA__VARIABLE);
		}
		return variable;
	}
	...
	public EList<String> getLogOper() {
		if (logOper == null) {
			logOper = new EDataTypeEList<String>(String.class, this, PaymentsAppPackage.EXPRESION_LOGICA__LOG_OPER);
		}
		return logOper;
	}
	...
	public EList<TerminalValue> getVariable2() {
		if (variable2 == null) {
			variable2 = new EObjectContainmentEList<TerminalValue>(TerminalValue.class, this, PaymentsAppPackage.EXPRESION_LOGICA__VARIABLE2);
		}
		return variable2;
	}
	...
	public EList<String> getLiteral() {
		if (literal == null) {
			literal = new EDataTypeEList<String>(String.class, this, PaymentsAppPackage.EXPRESION_LOGICA__LITERAL);
		}
		return literal;
	}
	...
	public EList<ExpresionLogica> getExp() {
		if (exp == null) {
			exp = new EObjectContainmentEList<ExpresionLogica>(ExpresionLogica.class, this, PaymentsAppPackage.EXPRESION_LOGICA__EXP);
		}
		return exp;
	}
