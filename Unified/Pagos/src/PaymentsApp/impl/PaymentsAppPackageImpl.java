...
public class PaymentsAppPackageImpl extends EPackageImpl implements PaymentsAppPackage {
	 ...
	 * @generated
	 */
	public EReference getIntermediary_BusinessValue() {
	 ...
	 * @generated
	 */
	public EReference getSuperEntity_BusinessFields() {
		return (EReference)superEntityEClass.getEStructuralFeatures().get(4);
	}
	...
	public EAttribute getDataForm_Name() {
		return (EAttribute)dataFormEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getDataForm_SuperEntityAttributes() {
	...
	public EReference getDataForm_BusinessFields() {
		return (EReference)dataFormEClass.getEStructuralFeatures().get(2);
	}
	...
	public void createPackageContents() {
		...
		createEReference(intermediaryEClass, INTERMEDIARY__BUSINESS_VALUE);
		...
		createEReference(superEntityEClass, SUPER_ENTITY__BUSINESS_FIELDS);
		...
		createEReference(dataFormEClass, DATA_FORM__SUPER_ENTITY_ATTRIBUTES);
	...
	public void initializePackageContents() {
		...
		initEReference(getIntermediary_BusinessValue(), this.getBusinessValue(), null, "businessValue", null, 1, 1, Intermediary.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getIntermediary_Templates(), this.getDataForm(), null, "templates", null, 0, -1, Intermediary.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getSuperEntity_BusinessFields(), this.getBusinessAttributeCollection(), null, "businessFields", null, 0, -1, SuperEntity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getBusinessAttribute_BusinessValue(), this.getBusinessValue(), null, "businessValue", null, 0, 1, BusinessAttribute.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getDataForm_SuperEntityAttributes(), this.getBusinessAttributeCollection(), null, "superEntityAttributes", null, 0, -1, DataForm.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
