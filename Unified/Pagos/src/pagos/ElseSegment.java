 ...
 * </p>
 * <ul>
 *   <li>{@link pagos.ElseSegment#getIfSentence <em>If Sentence</em>}</li>
 * </ul>
 *
 * @see pagos.PagosPackage#getElseSegment()
 * @model
 * @generated
 */
public interface ElseSegment extends EObject {
	 ...
	 * @see pagos.PagosPackage#getElseSegment_IfSentence()
	...
	/**
	 * Sets the value of the '{@link pagos.ElseSegment#getIfSentence <em>If Sentence</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
