...
/**
 * This is the item provider adapter for a {@link co.edu.uniandes.pagos.IfBlock} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IfBlockItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PagosPackage.Literals.IF_BLOCK__IF_SENTENCE);
			childrenFeatures.add(PagosPackage.Literals.IF_BLOCK__ELSE_SENTENCE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PagosPackage.Literals.IF_BLOCK__IF_SENTENCE,
				 PagosFactory.eINSTANCE.createIfCondition()));

		newChildDescriptors.add
			(createChildParameter
				(PagosPackage.Literals.IF_BLOCK__ELSE_SENTENCE,
				 PagosFactory.eINSTANCE.createElseSegment()));
	}
