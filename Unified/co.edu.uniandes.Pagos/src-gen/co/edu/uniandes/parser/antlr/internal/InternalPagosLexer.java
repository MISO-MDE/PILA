...
public class InternalPagosLexer extends Lexer {
    ...
    public final void mT__49() throws RecognitionException {
        try {
            int _type = T__49;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:30:7: ( 'size()' )
            // InternalPagos.g:30:9: 'size()'
            {
            match("size()"); 
    ...
    public final void mT__50() throws RecognitionException {
        try {
            int _type = T__50;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:31:7: ( 'getCantidadDiasHabiles()' )
            // InternalPagos.g:31:9: 'getCantidadDiasHabiles()'
            {
    ...
    public final void mT__51() throws RecognitionException {
        try {
            int _type = T__51;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:32:7: ( 'getRiegoTabla2()' )
            // InternalPagos.g:32:9: 'getRiegoTabla2()'
            {
    ...
    public final void mT__52() throws RecognitionException {
        try {
            int _type = T__52;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:33:7: ( 'E' )
            // InternalPagos.g:33:9: 'E'
            {
            match('E'); 
    ...
    public final void mT__53() throws RecognitionException {
        try {
            int _type = T__53;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:34:7: ( 'e' )
            // InternalPagos.g:34:9: 'e'
            {
            match('e'); 
    ...
    public final void mRULE_INDEX() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:2638:12: ( '@Indice' )
            // InternalPagos.g:2638:14: '@Indice'
            {
            match("@Indice"); 
    ...
    public final void mRULE_IF() throws RecognitionException {
        try {
            int _type = RULE_IF;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:2640:9: ( 'SI' )
            // InternalPagos.g:2640:11: 'SI'
            {
            match("SI"); 
    ...
    public final void mRULE_THEN() throws RecognitionException {
        try {
            int _type = RULE_THEN;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:2642:11: ( 'ENTONCES' )
            // InternalPagos.g:2642:13: 'ENTONCES'
            {
            match("ENTONCES"); 
    ...
    public final void mRULE_ELSE() throws RecognitionException {
        try {
            int _type = RULE_ELSE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:2644:11: ( 'SINO' )
            // InternalPagos.g:2644:13: 'SINO'
            {
            match("SINO"); 
    ...
    public final void mRULE_RETURN() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:2646:13: ( 'RETORNAR' )
            // InternalPagos.g:2646:15: 'RETORNAR'
            {
            match("RETORNAR"); 
    ...
    public final void mRULE_TYPE() throws RecognitionException {
        try {
            int _type = RULE_TYPE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:2648:11: ( ( 'String' | 'Integer' | 'Date' | 'Double' ) )
            // InternalPagos.g:2648:13: ( 'String' | 'Integer' | 'Date' | 'Double' )
            {
            // InternalPagos.g:2648:13: ( 'String' | 'Integer' | 'Date' | 'Double' )
            int alt1=4;
            switch ( input.LA(1) ) {
            ...
            switch (alt1) {
                case 1 :
                    // InternalPagos.g:2648:14: 'String'
                    {
                    match("String"); 
                    ...
                    break;
                case 2 :
                    // InternalPagos.g:2648:23: 'Integer'
                    {
                    match("Integer"); 
                ...
                case 3 :
                    ...
                    break;
                case 4 :
                    // InternalPagos.g:2648:40: 'Double'
                    {
                    match("Double"); 
    ...
    public final void mRULE_MULTOP() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:2650:13: ( ( '*' | '/' ) )
            // InternalPagos.g:2650:15: ( '*' | '/' )
            {
    ...
    public final void mRULE_ADDOP() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:2652:12: ( ( '+' | '-' ) )
            // InternalPagos.g:2652:14: ( '+' | '-' )
            {
            if ( input.LA(1)=='+'||input.LA(1)=='-' ) {
                input.consume();
    ...
    public final void mRULE_LOGICALCONN() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:2654:18: ( ( '&&' | '||' ) )
            // InternalPagos.g:2654:20: ( '&&' | '||' )
            {
            // InternalPagos.g:2654:20: ( '&&' | '||' )
            int alt2=2;
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:2656:9: ( ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalPagos.g:2656:11: ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            ...
            // InternalPagos.g:2656:35: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop3:
            do {
                int alt3=2;
    ...
    public final void mRULE_OPERADORLOGICO() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:2658:21: ( ( '<' | '>' | '<=' | '>=' | '==' | '<>' | '!=' ) )
            // InternalPagos.g:2658:23: ( '<' | '>' | '<=' | '>=' | '==' | '<>' | '!=' )
            {
            // InternalPagos.g:2658:23: ( '<' | '>' | '<=' | '>=' | '==' | '<>' | '!=' )
            int alt4=7;
    ...
    public final void mRULE_LBRACE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:2660:13: ( '{' )
            // InternalPagos.g:2660:15: '{'
            {
            match('{'); 
    ...
    public final void mRULE_RBRACE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:2662:13: ( '}' )
            // InternalPagos.g:2662:15: '}'
            {
            match('}'); 
    ...
    public final void mRULE_LBRACKET() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:2664:15: ( '[' )
            // InternalPagos.g:2664:17: '['
            {
            match('['); 
    ...
    public final void mRULE_RBRACKET() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:2666:15: ( ']' )
            // InternalPagos.g:2666:17: ']'
            {
            match(']'); 
    ...
    public final void mRULE_COMMA() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:2668:12: ( ',' )
            // InternalPagos.g:2668:14: ','
            {
            match(','); 
    ...
    public final void mRULE_COLON() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:2670:12: ( ':' )
            // InternalPagos.g:2670:14: ':'
            {
            match(':'); 
    ...
    public final void mRULE_DASH() throws RecognitionException {
        try {
            int _type = RULE_DASH;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:2672:11: ( '#' )
            // InternalPagos.g:2672:13: '#'
            {
            match('#'); 
    ...
    public final void mRULE_DOT() throws RecognitionException {
        try {
            int _type = RULE_DOT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:2674:10: ( '.' )
            // InternalPagos.g:2674:12: '.'
            {
            match('.'); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:2676:13: ( '\"' ( RULE_STR_ESC | ~ ( ( '\"' | '\\r' | '\\n' | '\\\\' ) ) )* '\"' )
            // InternalPagos.g:2676:15: '\"' ( RULE_STR_ESC | ~ ( ( '\"' | '\\r' | '\\n' | '\\\\' ) ) )* '\"'
            {
            match('\"'); 
            // InternalPagos.g:2676:19: ( RULE_STR_ESC | ~ ( ( '\"' | '\\r' | '\\n' | '\\\\' ) ) )*
            loop5:
            do {
                int alt5=3;
                ...
                switch (alt5) {
            	case 1 :
            	    // InternalPagos.g:2676:20: RULE_STR_ESC
            	    {
            	    mRULE_STR_ESC(); 
    ...
    public final void mRULE_STR_ESC() throws RecognitionException {
        try {
            // InternalPagos.g:2678:23: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\\\' | '$' ) )
            // InternalPagos.g:2678:25: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\\\' | '$' )
            {
            match('\\'); 
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:2680:10: ( ( '0' .. '9' )+ )
            // InternalPagos.g:2680:12: ( '0' .. '9' )+
            {
            // InternalPagos.g:2680:12: ( '0' .. '9' )+
            int cnt6=0;
            loop6:
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:2682:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalPagos.g:2682:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalPagos.g:2682:24: ( options {greedy=false; } : . )*
            loop7:
            do {
                int alt7=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:2684:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalPagos.g:2684:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalPagos.g:2684:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop8:
            do {
                int alt8=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:2686:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalPagos.g:2686:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalPagos.g:2686:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt11=0;
            loop11:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:2688:16: ( . )
            // InternalPagos.g:2688:18: .
            {
            matchAny(); 
    ...
    static final String DFA12_eotS =
        "\1\uffff\5\53\1\62\4\53\2\uffff\1\74\3\53\1\103\1\51\2\53\1\112\1\uffff\2\51\3\uffff\2\51\7\uffff\1\51\4\uffff\1\53\1\uffff\6\53\1\uffff\1\53\1\141\1\53\1\143\2\53\4\uffff\1\146\1\147\1\151\3\53\2\uffff\3\53\20\uffff\11\53\1\uffff\1\53\1\uffff\2\53\2\uffff\1\53\1\uffff\6\53\1\u0084\13\53\1\u0090\5\53\1\u0096\1\53\1\uffff\2\53\1\uffff\10\53\1\uffff\5\53\1\uffff\13\53\1\u0096\4\53\1\u0096\6\53\1\u0096\13\53\1\u00c7\6\53\1\u00ce\1\u00cf\4\53\1\uffff\3\53\1\u00d7\2\53\2\uffff\3\53\1\u00dd\3\53\1\uffff\4\53\1\u00e5\1\uffff\5\53\1\u00ed\1\53\1\uffff\7\53\1\uffff\1\u00f6\7\53\1\uffff\1\53\1\u00ff\6\53\1\uffff\4\53\1\uffff\3\53\1\u010d\4\53\1\uffff\5\53\1\u0117\3\53\1\uffff\1\u011b\2\53\1\uffff\1\u011e\1\53\1\uffff\1\53\1\uffff";
    static final String DFA12_eofS =
        "\u0121\uffff";
    static final String DFA12_minS =
    static final String DFA12_acceptS =
        "\13\uffff\1\15\1\16\11\uffff\1\40\2\uffff\1\42\2\43\2\uffff\1\44\1\45\1\46\1\47\1\50\1\52\1\53\1\uffff\1\55\1\37\1\60\1\61\1\uffff\1\42\6\uffff\1\30\6\uffff\1\15\1\16\1\17\1\51\6\uffff\1\27\1\31\3\uffff\1\56\1\57\1\37\1\40\1\41\1\43\1\44\1\45\1\46\1\47\1\50\1\52\1\53\1\54\1\55\1\60\11\uffff\1\22\1\uffff\1\23\2\uffff\1\20\1\21\1\uffff\1\32\32\uffff\1\1\2\uffff\1\24\10\uffff\1\34\5\uffff\1\36\60\uffff\1\6\6\uffff\1\33\1\35\7\uffff\1\12\5\uffff\1\5\7\uffff\1\4\7\uffff\1\2\10\uffff\1\3\10\uffff\1\10\4\uffff\1\26\10\uffff\1\14\11\uffff\1\7\3\uffff\1\11\2\uffff\1\13\1\uffff\1\25";
    static final String DFA12_specialS =
        "\1\1\44\uffff\1\0\u00fb\uffff}>";
    static final String[] DFA12_transitionS = {
            "\11\51\2\50\2\51\1\50\22\51\1\50\1\35\1\45\1\43\2\51\1\27\1\51\1\13\1\14\1\47\1\26\1\42\1\26\1\44\1\25\12\46\1\15\1\51\1\32\1\34\1\33\1\51\1\22\3\31\1\24\1\21\1\10\2\31\1\7\6\31\1\16\1\31\1\23\1\17\7\31\1\40\1\51\1\41\1\51\1\31\1\51\1\5\1\31\1\11\1\4\1\6\1\31\1\20\1\31\1\2\4\31\1\1\1\31\1\12\2\31\1\3\7\31\1\36\1\30\1\37\uff82\51",
            "\1\52",
            "\1\54",
            "\1\56\13\uffff\1\55",
            "\1\57",
            "\1\60",
            "\12\53\7\uffff\32\53\4\uffff\1\53\1\uffff\15\53\1\61\14\53",
            "\1\64\31\uffff\1\63",
            "\1\66\31\uffff\1\65",
            "\1\67",
            "\1\70",
            ...
            "\1\73",
            "\1\75",
            "\1\77\13\uffff\1\76\36\uffff\1\100",
            "\1\101",
            "\12\53\7\uffff\15\53\1\102\14\53\4\uffff\1\53\1\uffff\32\53",
            "\1\104",
            "\1\105",
            "\1\106\15\uffff\1\107",
            "\1\110\4\uffff\1\111",
            ...
            "\12\53\7\uffff\32\53\4\uffff\1\53\1\uffff\32\53",
            "\12\53\7\uffff\32\53\4\uffff\1\53\1\uffff\32\53",
            "\12\53\7\uffff\15\53\1\150\14\53\4\uffff\1\53\1\uffff\32\53",
            "\1\152",
            "\1\153",
            "\1\154",
            "",
        ...
        public int specialStateTransition(int s, IntStream _input) throws NoViableAltException {
            ...
            switch ( s ) {
                    case 0 : 
                        ...
                        s = -1;
                        if ( ((LA12_37>='\u0000' && LA12_37<='\t')||(LA12_37>='\u000B' && LA12_37<='\f')||(LA12_37>='\u000E' && LA12_37<='\uFFFF')) ) {s = 85;}
                    ...
                    case 1 : 
                        ...
                        else if ( (LA12_0=='+'||LA12_0=='-') ) {s = 22;}

                        else if ( (LA12_0=='&') ) {s = 23;}

                        else if ( (LA12_0=='|') ) {s = 24;}

                        else if ( ((LA12_0>='A' && LA12_0<='C')||(LA12_0>='G' && LA12_0<='H')||(LA12_0>='J' && LA12_0<='O')||LA12_0=='Q'||(LA12_0>='T' && LA12_0<='Z')||LA12_0=='_'||LA12_0=='b'||LA12_0=='f'||LA12_0=='h'||(LA12_0>='j' && LA12_0<='m')||LA12_0=='o'||(LA12_0>='q' && LA12_0<='r')||(LA12_0>='t' && LA12_0<='z')) ) {s = 25;}
