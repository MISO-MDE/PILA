...
public class InternalPagosLexer extends Lexer {
    ...
    public final void mRULE_IF() throws RecognitionException {
        try {
            int _type = RULE_IF;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:2274:9: ( 'SI' )
            // InternalPagos.g:2274:11: 'SI'
            {
            match("SI"); 
    ...
    public final void mRULE_THEN() throws RecognitionException {
        try {
            int _type = RULE_THEN;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:2276:11: ( 'ENTONCES' )
            // InternalPagos.g:2276:13: 'ENTONCES'
            {
            match("ENTONCES"); 
    ...
    public final void mRULE_ELSE() throws RecognitionException {
        try {
            int _type = RULE_ELSE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:2278:11: ( 'SINO' )
            // InternalPagos.g:2278:13: 'SINO'
            {
            match("SINO"); 
    ...
    public final void mRULE_RETURN() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:2280:13: ( 'RETORNAR' )
            // InternalPagos.g:2280:15: 'RETORNAR'
            {
            match("RETORNAR"); 
    ...
    public final void mRULE_TYPE() throws RecognitionException {
        try {
            int _type = RULE_TYPE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:2282:11: ( ( 'String' | 'Integer' | 'Date' | 'Double' ) )
            // InternalPagos.g:2282:13: ( 'String' | 'Integer' | 'Date' | 'Double' )
            {
            // InternalPagos.g:2282:13: ( 'String' | 'Integer' | 'Date' | 'Double' )
            int alt1=4;
            switch ( input.LA(1) ) {
            ...
            switch (alt1) {
                case 1 :
                    // InternalPagos.g:2282:14: 'String'
                    {
                    match("String"); 
                    ...
                    break;
                case 2 :
                    // InternalPagos.g:2282:23: 'Integer'
                    {
                    match("Integer"); 
                ...
                case 3 :
                    ...
                    break;
                case 4 :
                    // InternalPagos.g:2282:40: 'Double'
                    {
                    match("Double"); 
    ...
    public final void mRULE_MULTOP() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:2284:13: ( ( '*' | '/' ) )
            // InternalPagos.g:2284:15: ( '*' | '/' )
            {
    ...
    public final void mRULE_ADDOP() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:2286:12: ( ( '+' | '-' ) )
            // InternalPagos.g:2286:14: ( '+' | '-' )
            {
            if ( input.LA(1)=='+'||input.LA(1)=='-' ) {
                input.consume();
    ...
    public final void mRULE_LOGICALCONN() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:2288:18: ( ( '&&' | '||' ) )
            // InternalPagos.g:2288:20: ( '&&' | '||' )
            {
            // InternalPagos.g:2288:20: ( '&&' | '||' )
            int alt2=2;
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:2290:9: ( ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* ( '.' ( 'Ultima' | 'Primera' | 'Tamano' ) )* )
            // InternalPagos.g:2290:11: ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* ( '.' ( 'Ultima' | 'Primera' | 'Tamano' ) )*
            {
            ...
            // InternalPagos.g:2290:35: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop3:
            do {
                int alt3=2;
            ...
            // InternalPagos.g:2290:69: ( '.' ( 'Ultima' | 'Primera' | 'Tamano' ) )*
            loop5:
            do {
                int alt5=2;
                ...
                switch (alt5) {
            	case 1 :
            	    // InternalPagos.g:2290:70: '.' ( 'Ultima' | 'Primera' | 'Tamano' )
            	    {
            	    match('.'); 
            	    // InternalPagos.g:2290:74: ( 'Ultima' | 'Primera' | 'Tamano' )
            	    int alt4=3;
            	    switch ( input.LA(1) ) {
            	    case 'U':
            	        {
            	    ...
            	    switch (alt4) {
            	        case 1 :
            	            // InternalPagos.g:2290:75: 'Ultima'
            	            {
            	            match("Ultima"); 
            	            ...
            	            break;
            	        case 2 :
            	            // InternalPagos.g:2290:84: 'Primera'
            	            {
            	            match("Primera"); 
            	            ...
            	            break;
            	        case 3 :
            	            // InternalPagos.g:2290:94: 'Tamano'
            	            {
            	            match("Tamano"); 
    ...
    public final void mRULE_OPERADORLOGICO() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:2292:21: ( ( '<' | '>' | '<=' | '>=' | '=' | '<>' ) )
            // InternalPagos.g:2292:23: ( '<' | '>' | '<=' | '>=' | '=' | '<>' )
            {
            // InternalPagos.g:2292:23: ( '<' | '>' | '<=' | '>=' | '=' | '<>' )
            int alt6=6;
            switch ( input.LA(1) ) {
    ...
    public final void mRULE_LBRACE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:2294:13: ( '{' )
            // InternalPagos.g:2294:15: '{'
            {
            match('{'); 
    ...
    public final void mRULE_RBRACE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:2296:13: ( '}' )
            // InternalPagos.g:2296:15: '}'
            {
            match('}'); 
    ...
    public final void mRULE_COMMA() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:2302:12: ( ',' )
            // InternalPagos.g:2302:14: ','
            {
            match(','); 
    ...
    public final void mRULE_COLON() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:2304:12: ( ':' )
            // InternalPagos.g:2304:14: ':'
            {
            match(':'); 
    ...
    public final void mRULE_DASH() throws RecognitionException {
        try {
            int _type = RULE_DASH;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:2306:11: ( '#' )
            // InternalPagos.g:2306:13: '#'
            {
            match('#'); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:2308:13: ( '\"' ( RULE_STR_ESC | ~ ( ( '\"' | '\\r' | '\\n' | '\\\\' ) ) )* '\"' )
            // InternalPagos.g:2308:15: '\"' ( RULE_STR_ESC | ~ ( ( '\"' | '\\r' | '\\n' | '\\\\' ) ) )* '\"'
            {
            match('\"'); 
            // InternalPagos.g:2308:19: ( RULE_STR_ESC | ~ ( ( '\"' | '\\r' | '\\n' | '\\\\' ) ) )*
            loop7:
            do {
                int alt7=3;
                ...
                switch (alt7) {
            	case 1 :
            	    // InternalPagos.g:2308:20: RULE_STR_ESC
            	    {
            	    mRULE_STR_ESC(); 
    ...
    public final void mRULE_STR_ESC() throws RecognitionException {
        try {
            // InternalPagos.g:2310:23: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\\\' | '$' ) )
            // InternalPagos.g:2310:25: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\\\' | '$' )
            {
            match('\\'); 
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:2312:10: ( ( '0' .. '9' )+ )
            // InternalPagos.g:2312:12: ( '0' .. '9' )+
            {
            // InternalPagos.g:2312:12: ( '0' .. '9' )+
            int cnt8=0;
            loop8:
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:2314:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalPagos.g:2314:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalPagos.g:2314:24: ( options {greedy=false; } : . )*
            loop9:
            do {
                int alt9=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:2316:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalPagos.g:2316:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalPagos.g:2316:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop10:
            do {
                int alt10=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:2318:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalPagos.g:2318:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalPagos.g:2318:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt13=0;
            loop13:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:2320:16: ( . )
            // InternalPagos.g:2320:18: .
            {
            matchAny(); 
