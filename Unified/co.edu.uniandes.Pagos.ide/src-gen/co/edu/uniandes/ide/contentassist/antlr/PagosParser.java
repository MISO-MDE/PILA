		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getTerminalValueAccess().getAlternatives_0_1(), "rule__TerminalValue__Alternatives_0_1");
					put(grammarAccess.getTerminalValueAccess().getAlternatives_1(), "rule__TerminalValue__Alternatives_1");
					put(grammarAccess.getTerminalValueAccess().getAlternatives_2(), "rule__TerminalValue__Alternatives_2");
					...
					put(grammarAccess.getInformationTemplateAccess().getGroup_17_6(), "rule__InformationTemplate__Group_17_6__0");
					...
					put(grammarAccess.getTerminalValueAccess().getGroup_0_1_0(), "rule__TerminalValue__Group_0_1_0__0");
					put(grammarAccess.getTerminalValueAccess().getGroup_0_1_0_0(), "rule__TerminalValue__Group_0_1_0_0__0");
					put(grammarAccess.getTerminalValueAccess().getGroup_0_1_1(), "rule__TerminalValue__Group_0_1_1__0");
					put(grammarAccess.getTerminalValueAccess().getGroup_1_0(), "rule__TerminalValue__Group_1_0__0");
					put(grammarAccess.getTerminalValueAccess().getGroup_1_1(), "rule__TerminalValue__Group_1_1__0");
					put(grammarAccess.getTerminalValueAccess().getGroup_2_0(), "rule__TerminalValue__Group_2_0__0");
					put(grammarAccess.getTerminalValueAccess().getGroup_2_1(), "rule__TerminalValue__Group_2_1__0");
					...
					put(grammarAccess.getInformationTemplateAccess().getTemplateCalcAssignment_17_2(), "rule__InformationTemplate__TemplateCalcAssignment_17_2");
					put(grammarAccess.getInformationTemplateAccess().getTemplatesAssignment_17_5(), "rule__InformationTemplate__TemplatesAssignment_17_5");
					put(grammarAccess.getInformationTemplateAccess().getTemplatesAssignment_17_6_1(), "rule__InformationTemplate__TemplatesAssignment_17_6_1");
					...
					put(grammarAccess.getTerminalValueAccess().getParentAssignment_0_1_0_0_2(), "rule__TerminalValue__ParentAssignment_0_1_0_0_2");
					put(grammarAccess.getTerminalValueAccess().getVariableAssignment_0_1_0_1(), "rule__TerminalValue__VariableAssignment_0_1_0_1");
					put(grammarAccess.getTerminalValueAccess().getParentAssignment_0_1_1_2(), "rule__TerminalValue__ParentAssignment_0_1_1_2");
					put(grammarAccess.getTerminalValueAccess().getMethodAssignment_0_1_1_4(), "rule__TerminalValue__MethodAssignment_0_1_1_4");
					put(grammarAccess.getTerminalValueAccess().getParentAssignment_1_0_2(), "rule__TerminalValue__ParentAssignment_1_0_2");
					put(grammarAccess.getTerminalValueAccess().getVariableAssignment_1_0_4(), "rule__TerminalValue__VariableAssignment_1_0_4");
					put(grammarAccess.getTerminalValueAccess().getParentAssignment_1_1_2(), "rule__TerminalValue__ParentAssignment_1_1_2");
					put(grammarAccess.getTerminalValueAccess().getMethodAssignment_1_1_4(), "rule__TerminalValue__MethodAssignment_1_1_4");
					put(grammarAccess.getTerminalValueAccess().getParentAssignment_2_0_2(), "rule__TerminalValue__ParentAssignment_2_0_2");
					put(grammarAccess.getTerminalValueAccess().getVariableAssignment_2_0_4(), "rule__TerminalValue__VariableAssignment_2_0_4");
					put(grammarAccess.getTerminalValueAccess().getParentAssignment_2_1_2(), "rule__TerminalValue__ParentAssignment_2_1_2");
					put(grammarAccess.getTerminalValueAccess().getMethodAssignment_2_1_4(), "rule__TerminalValue__MethodAssignment_2_1_4");
