...
public class InternalPagosLexer extends Lexer {
    ...
    public final void mRULE_IF() throws RecognitionException {
        try {
            int _type = RULE_IF;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:7590:9: ( 'SI' )
            // InternalPagos.g:7590:11: 'SI'
            {
            match("SI"); 
    ...
    public final void mRULE_THEN() throws RecognitionException {
        try {
            int _type = RULE_THEN;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:7592:11: ( 'ENTONCES' )
            // InternalPagos.g:7592:13: 'ENTONCES'
            {
            match("ENTONCES"); 
    ...
    public final void mRULE_ELSE() throws RecognitionException {
        try {
            int _type = RULE_ELSE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:7594:11: ( 'SINO' )
            // InternalPagos.g:7594:13: 'SINO'
            {
            match("SINO"); 
    ...
    public final void mRULE_RETURN() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:7596:13: ( 'RETORNAR' )
            // InternalPagos.g:7596:15: 'RETORNAR'
            {
            match("RETORNAR"); 
    ...
    public final void mRULE_TYPE() throws RecognitionException {
        try {
            int _type = RULE_TYPE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:7598:11: ( ( 'String' | 'Integer' | 'Date' | 'Double' ) )
            // InternalPagos.g:7598:13: ( 'String' | 'Integer' | 'Date' | 'Double' )
            {
            // InternalPagos.g:7598:13: ( 'String' | 'Integer' | 'Date' | 'Double' )
            int alt1=4;
            switch ( input.LA(1) ) {
            ...
            switch (alt1) {
                case 1 :
                    // InternalPagos.g:7598:14: 'String'
                    {
                    match("String"); 
                    ...
                    break;
                case 2 :
                    // InternalPagos.g:7598:23: 'Integer'
                    {
                    match("Integer"); 
                ...
                case 3 :
                    ...
                    break;
                case 4 :
                    // InternalPagos.g:7598:40: 'Double'
                    {
                    match("Double"); 
    ...
    public final void mRULE_MULTOP() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:7600:13: ( ( '*' | '/' ) )
            // InternalPagos.g:7600:15: ( '*' | '/' )
            {
    ...
    public final void mRULE_ADDOP() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:7602:12: ( ( '+' | '-' ) )
            // InternalPagos.g:7602:14: ( '+' | '-' )
            {
            if ( input.LA(1)=='+'||input.LA(1)=='-' ) {
                input.consume();
    ...
    public final void mRULE_LOGICALCONN() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:7604:18: ( ( '&&' | '||' ) )
            // InternalPagos.g:7604:20: ( '&&' | '||' )
            {
            // InternalPagos.g:7604:20: ( '&&' | '||' )
            int alt2=2;
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:7606:9: ( ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* ( '.' ( 'Ultima' | 'Primera' | 'Tamano' ) )* )
            // InternalPagos.g:7606:11: ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* ( '.' ( 'Ultima' | 'Primera' | 'Tamano' ) )*
            {
            ...
            // InternalPagos.g:7606:35: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop3:
            do {
                int alt3=2;
            ...
            // InternalPagos.g:7606:69: ( '.' ( 'Ultima' | 'Primera' | 'Tamano' ) )*
            loop5:
            do {
                int alt5=2;
                ...
                switch (alt5) {
            	case 1 :
            	    // InternalPagos.g:7606:70: '.' ( 'Ultima' | 'Primera' | 'Tamano' )
            	    {
            	    match('.'); 
            	    // InternalPagos.g:7606:74: ( 'Ultima' | 'Primera' | 'Tamano' )
            	    int alt4=3;
            	    switch ( input.LA(1) ) {
            	    case 'U':
            	        {
            	    ...
            	    switch (alt4) {
            	        case 1 :
            	            // InternalPagos.g:7606:75: 'Ultima'
            	            {
            	            match("Ultima"); 
            	            ...
            	            break;
            	        case 2 :
            	            // InternalPagos.g:7606:84: 'Primera'
            	            {
            	            match("Primera"); 
            	            ...
            	            break;
            	        case 3 :
            	            // InternalPagos.g:7606:94: 'Tamano'
            	            {
            	            match("Tamano"); 
    ...
    public final void mRULE_OPERADORLOGICO() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:7608:21: ( ( '<' | '>' | '<=' | '>=' | '=' | '<>' ) )
            // InternalPagos.g:7608:23: ( '<' | '>' | '<=' | '>=' | '=' | '<>' )
            {
            // InternalPagos.g:7608:23: ( '<' | '>' | '<=' | '>=' | '=' | '<>' )
            int alt6=6;
            switch ( input.LA(1) ) {
    ...
    public final void mRULE_LBRACE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:7610:13: ( '{' )
            // InternalPagos.g:7610:15: '{'
            {
            match('{'); 
    ...
    public final void mRULE_RBRACE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:7612:13: ( '}' )
            // InternalPagos.g:7612:15: '}'
            {
            match('}'); 
    ...
    public final void mRULE_LBRACKET() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:7614:15: ( '[' )
            // InternalPagos.g:7614:17: '['
            {
            match('['); 
    ...
    public final void mRULE_RBRACKET() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:7616:15: ( ']' )
            // InternalPagos.g:7616:17: ']'
            {
            match(']'); 
    ...
    public final void mRULE_COMMA() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:7618:12: ( ',' )
            // InternalPagos.g:7618:14: ','
            {
            match(','); 
    ...
    public final void mRULE_COLON() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:7620:12: ( ':' )
            // InternalPagos.g:7620:14: ':'
            {
            match(':'); 
    ...
    public final void mRULE_DASH() throws RecognitionException {
        try {
            int _type = RULE_DASH;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:7622:11: ( '#' )
            // InternalPagos.g:7622:13: '#'
            {
            match('#'); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:7624:13: ( '\"' ( RULE_STR_ESC | ~ ( ( '\"' | '\\r' | '\\n' | '\\\\' ) ) )* '\"' )
            // InternalPagos.g:7624:15: '\"' ( RULE_STR_ESC | ~ ( ( '\"' | '\\r' | '\\n' | '\\\\' ) ) )* '\"'
            {
            match('\"'); 
            // InternalPagos.g:7624:19: ( RULE_STR_ESC | ~ ( ( '\"' | '\\r' | '\\n' | '\\\\' ) ) )*
            loop7:
            do {
                int alt7=3;
                ...
                switch (alt7) {
            	case 1 :
            	    // InternalPagos.g:7624:20: RULE_STR_ESC
            	    {
            	    mRULE_STR_ESC(); 
    ...
    public final void mRULE_STR_ESC() throws RecognitionException {
        try {
            // InternalPagos.g:7626:23: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\\\' | '$' ) )
            // InternalPagos.g:7626:25: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\\\' | '$' )
            {
            match('\\'); 
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:7628:10: ( ( '0' .. '9' )+ )
            // InternalPagos.g:7628:12: ( '0' .. '9' )+
            {
            // InternalPagos.g:7628:12: ( '0' .. '9' )+
            int cnt8=0;
            loop8:
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:7630:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalPagos.g:7630:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalPagos.g:7630:24: ( options {greedy=false; } : . )*
            loop9:
            do {
                int alt9=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:7632:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalPagos.g:7632:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalPagos.g:7632:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop10:
            do {
                int alt10=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:7634:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalPagos.g:7634:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalPagos.g:7634:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt13=0;
            loop13:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPagos.g:7636:16: ( . )
            // InternalPagos.g:7636:18: .
            {
            matchAny(); 
