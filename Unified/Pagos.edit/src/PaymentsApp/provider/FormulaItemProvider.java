...
/**
 * This is the item provider adapter for a {@link PaymentsApp.Formula} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FormulaItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PaymentsAppPackage.Literals.FORMULA__FORMULA_BODY);
			childrenFeatures.add(PaymentsAppPackage.Literals.FORMULA__FORMULA_RETURN);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PaymentsAppPackage.Literals.FORMULA__FORMULA_BODY,
				 PaymentsAppFactory.eINSTANCE.createIfBlock()));

		newChildDescriptors.add
			(createChildParameter
				(PaymentsAppPackage.Literals.FORMULA__FORMULA_RETURN,
				 PaymentsAppFactory.eINSTANCE.createReturnBlock()));
	}
