...
/**
 * This is the item provider adapter for a {@link PaymentsApp.IfBlock} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IfBlockItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PaymentsAppPackage.Literals.IF_BLOCK__IF_SENTENCE);
			childrenFeatures.add(PaymentsAppPackage.Literals.IF_BLOCK__ELSE_SENTENCE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PaymentsAppPackage.Literals.IF_BLOCK__IF_SENTENCE,
				 PaymentsAppFactory.eINSTANCE.createIfCondition()));

		newChildDescriptors.add
			(createChildParameter
				(PaymentsAppPackage.Literals.IF_BLOCK__ELSE_SENTENCE,
				 PaymentsAppFactory.eINSTANCE.createElseSegment()));
	}
