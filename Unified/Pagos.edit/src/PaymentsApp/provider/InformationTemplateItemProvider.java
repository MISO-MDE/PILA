...
public class InformationTemplateItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PaymentsAppPackage.Literals.INFORMATION_TEMPLATE__ATT_LISTS);
			childrenFeatures.add(PaymentsAppPackage.Literals.INFORMATION_TEMPLATE__TEMPLATES);
			childrenFeatures.add(PaymentsAppPackage.Literals.INFORMATION_TEMPLATE__PROVIDERS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PaymentsAppPackage.Literals.INFORMATION_TEMPLATE__ATT_LISTS,
				 PaymentsAppFactory.eINSTANCE.createBusinessAttribute()));

		newChildDescriptors.add
			(createChildParameter
				(PaymentsAppPackage.Literals.INFORMATION_TEMPLATE__TEMPLATES,
				 PaymentsAppFactory.eINSTANCE.createCalculationTemplate()));

		newChildDescriptors.add
			(createChildParameter
				(PaymentsAppPackage.Literals.INFORMATION_TEMPLATE__PROVIDERS,
