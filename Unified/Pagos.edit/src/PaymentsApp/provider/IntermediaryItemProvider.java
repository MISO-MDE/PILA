...
public class IntermediaryItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PaymentsAppPackage.Literals.INTERMEDIARY__SUPERENTITIES);
			childrenFeatures.add(PaymentsAppPackage.Literals.INTERMEDIARY__BUSINESS_VALUE);
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PaymentsAppPackage.Literals.INTERMEDIARY__SUPERENTITIES,
				 PaymentsAppFactory.eINSTANCE.createSuperEntity()));

		newChildDescriptors.add
			(createChildParameter
				(PaymentsAppPackage.Literals.INTERMEDIARY__BUSINESS_VALUE,
